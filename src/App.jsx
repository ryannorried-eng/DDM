    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <header className="bg-steel-900 text-white shadow-lg">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-steel-300 leading-none">DDM Metal Building Components</p>
      ...
      <footer className="bg-white border-t border-slate-200 py-4 text-center">
        <p className="text-xs text-slate-400">
          © {new Date().getFullYear()} DDM Metal Building Components. All rights reserved.
